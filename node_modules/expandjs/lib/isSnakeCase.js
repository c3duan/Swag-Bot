...
/**
 * Checks if `value` is a snake cased `string`.
 *
 * ```js
 * XP.isSnakeCase('hello_world');
 * // => true
 *
 * XP.isSnakeCase('Hello world');
 * // => false
 * ```
 *
 ...
 * @since 1.0.0
 * @category tester
 * @description Checks if `value` is a snake cased `string`
 * @source https://github.com/expandjs/expandjs/blog/master/lib/isSnakeCase.js
 *
