 ...
 *     // => <li class="item-4"></li>
 *
 *     XP.findParentElement(el, 'ul');
 *     // => <ul id="sublist">...</ul>
 *
 *     XP.findParentElement(el, 'ul', document.querySelector('.subheader'));
 *     // => <ul id="sublist">...</ul>
 * </script>
 * ```
 *
 ...
 * @since 1.0.0
 * @category dom
 * @description Returns a `node`'s last parent
 * @source https://github.com/expandjs/expandjs/blog/master/lib/findParentElement.js
 *
